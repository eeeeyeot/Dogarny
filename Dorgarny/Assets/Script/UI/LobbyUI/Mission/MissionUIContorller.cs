...
public class MissionUIContorller : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            if (missionSO.missionList[i].clearMission)
                missionUIs[i].rewardbtn.interactable = true;
            else if(!missionSO.missionList[i].clearMission || missionSO.missionList[i].getReward)
    ...
    { 
        ...
        {
            if (missionSO.missionList[i].getReward)
                missionUIs[i].rewardbtn.interactable = false;
