...
public class EquipmentManager : MonoBehaviour
{
   ...
   //     if (newItem != null)
   //     {
			//CharacterManager.instance.stats_List[playerIndex].def.AddModifier(newItem.armorModifier);
			//CharacterManager.instance.stats_List[playerIndex].atk.AddModifier(newItem.damageModifier);
   //     }

   //     if (oldItem != null)
   //     {
			//CharacterManager.instance.stats_List[playerIndex].def.RemoveModifier(oldItem.armorModifier);
			//CharacterManager.instance.stats_List[playerIndex].atk.RemoveModifier(oldItem.damageModifier);
   //     }
   // }
}